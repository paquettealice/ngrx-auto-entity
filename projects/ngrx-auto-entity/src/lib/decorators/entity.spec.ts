...
import { all, curd, Entity, ENTITY_OPTS_PROP, except, extra, loads, matching, shouldApplyEffect } from './entity';
import { Key } from './key';
...
describe('Decorator: @Entity', () => {
  ...
  test('should add all effects except Clear as exclusions', () => {
    @Entity({ excludeEffects: all.except(EntityActionTypes.Clear) })
    class Model {}
  ...
  test('should add loads effects except Load as exclusions', () => {
    @Entity({ excludeEffects: loads.except(EntityActionTypes.Load) })
    class Model {}
  ...
  test('should add curd effects except Create as exclusions', () => {
    @Entity({ excludeEffects: curd.except(EntityActionTypes.Create) })
    class Model {}
  ...
  test('should add extra effects except Select as exclusions', () => {
    @Entity({ excludeEffects: extra.except(EntityActionTypes.Select) })
    class Model {}
  ...
  test('should add matching effects as exclusions', () => {
    @Entity({ excludeEffects: matching(EntityActionTypes.Select, EntityActionTypes.Clear, EntityActionTypes.Load) })
    class Model {}
...
describe('Operator: shouldApplyEffect', () => {
  ...
  test('should filter out model with exclusion', () => {
    @Entity({ excludeEffects: matching(EntityActionTypes.Clear) })
    class Model {
      @Key id: number;
    }
